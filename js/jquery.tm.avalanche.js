...
;(function( $, document, window, undefined ) {
	...
	*/
	...
	var redimensionSlider = function( slide, settings ){
		...
		var newSliderW = settings.fullscreen || settings.fullwidth ? $( window ).width() : parentW;
		var newSliderH = settings.fullscreen ? $( window ).height() : settings.carousel && settings.carouselVisible > 1 && !settings.carouselScaleHeight ? refH : settings.fullwidth && parentW / sliderR > refH ? refH : parentW / sliderR;
	...
	*/
	...
	$.fn.avalancheSlider.tmsOpts = {
		...
		// Scaling
		forceFit: false,								// Force fits all slide images to slide, ude data-force-fit for individual images
